...
# Configuration Script – AP-nodemcu-esp8266 - Rev. A

This **Configuration** script is designed for the **AP-nodemcu-esp8266** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – AP-nodemcu-esp8266 Rev. A

Este script de **Configuration** está diseñado para el modelo **AP-nodemcu-esp8266** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
